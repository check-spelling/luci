...
var CBIAbstractElement = baseclass.extend(/** @lends LuCI.form.AbstractElement.prototype */ {
	 ...
	 *
	 * Elements which are hidden due to unsatisified dependencys are skipped.
	 *
...
var CBIAbstractSection = CBIAbstractElement.extend(/** @lends LuCI.form.AbstractSection.prototype */ {
	 ...
	 * option element.
	 *
	 * Options which are hidden due to unsatisified dependencys are skipped.
	 *
	 * @returns {Promise<void>}
	 * Returns a promise resolving once the values of all child elements have
 ...
 * handling option input values, for dependencys among options and for
...
var CBIAbstractValue = CBIAbstractElement.extend(/** @lends LuCI.form.AbstractValue.prototype */ {
	 ...
	 * same form. An option element with unsatisfied dependencys will be
	 ...
	 * dependencys which must be satified (a logical "and" expression).
	 *
	 ...
	 *
	 * This function is invoked upon saving the parent form when the option
	 * element has been hidden due to unsatisfied dependencys or when the
