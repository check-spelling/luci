...
var UIElement = baseclass.extend(/** @lends LuCI.ui.AbstractElement.prototype */ {
	 ...
	 * field dependencys to get re-evaluated and will mark the input widget
	 * as dirty.
	 *
	 * @instance
	 * @memberof LuCI.ui.AbstractElement
 ...
 * @classdesc
 *
 * The `Select` class implements either a tradditional HTML `<select>` element
...
var UIMenu = baseclass.singleton(/** @lends LuCI.ui.menu.prototype */ {
	 ...
	 * @property {satisified} boolean - Boolean indicating whether the menu entries dependencys are satisfied
